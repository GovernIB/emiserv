...
CREATE TABLE ems_redir_peticio (id NUMBER(38, 0) NOT NULL, data_comprovacio TIMESTAMP, data_peticio TIMESTAMP, data_resposta TIMESTAMP, emissor_codi VARCHAR2(10), error CLOB, estat VARCHAR2(16) NOT NULL, num_enviaments INTEGER NOT NULL, num_transmissions INTEGER NOT NULL, peticio_id VARCHAR2(128) NOT NULL, servei_codi VARCHAR2(256) NOT NULL, sincrona NUMBER(1), ter TIMESTAMP, version NUMBER(38, 0) NOT NULL, CONSTRAINT ems_redir_pet_pk PRIMARY KEY (id));
