--------------------------------------------------------
--  Creación de esquema scsp emisor 
--------------------------------------------------------  
...
--  Creación del procedimiento almacenado para generar las secuencias del id de transmisión
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   COMMENT ON COLUMN "AUTORIZACION_APLICACION"."IDAPLICACION" IS 'Identificador de la aplicación. Se va a generar automáticamente';
   COMMENT ON COLUMN "AUTORIZACION_APLICACION"."NIFCERTIFICADO" IS 'Nif del certificado con el que la aplicación firmara las peticiones';
   COMMENT ON COLUMN "AUTORIZACION_APLICACION"."NUMEROSERIE" IS 'Numero de serie del certificado con el que la aplicación firmara las peticiones';
   COMMENT ON COLUMN "AUTORIZACION_APLICACION"."CN" IS 'Common Name del certificado con el que la aplicación firmara las peticiones';
   COMMENT ON COLUMN "AUTORIZACION_APLICACION"."TIEMPOCOMPROBACION" IS 'Fecha en que se realizo la operación de validar el certificado';
   COMMENT ON COLUMN "AUTORIZACION_APLICACION"."AUTORIDADCERTIF" IS 'Autoridad de certificación del certificado';
   COMMENT ON COLUMN "AUTORIZACION_APLICACION"."FECHAALTA" IS 'Fecha en la que se da de alta la aplicación';
   COMMENT ON COLUMN "AUTORIZACION_APLICACION"."FECHABAJA" IS 'Fecha a partir de la cual la aplicación no va a poder acceder a ningún servicio';
...
--------------------------------------------------------
   ...
   COMMENT ON COLUMN "AUTORIZACION_CA"."CODCA" IS 'Codigo de la autoridad de certificación (Ej: FNMT)';
   COMMENT ON COLUMN "AUTORIZACION_CA"."NOMBRE" IS 'Nombre de la autoridad de certificación  (Ej: Fabrica Nacional de Moneda y Timbre)';
   COMMENT ON TABLE "AUTORIZACION_CA"  IS 'Contiene la información relativa a las distintas autoridades de certificación reconocidas por la aplicación';
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   COMMENT ON COLUMN "AUTORIZACION_CERTIFICADO"."IDAPLICACION" IS 'Identificador de la aplicación autorizada';
   COMMENT ON COLUMN "AUTORIZACION_CERTIFICADO"."IDORGANISMO" IS 'Identificador del organismo';
   COMMENT ON COLUMN "AUTORIZACION_CERTIFICADO"."FECHAALTA" IS 'Fecha de alta de la autorización';
   COMMENT ON COLUMN "AUTORIZACION_CERTIFICADO"."FECHABAJA" IS 'Fecha de baja de la autorización';
   COMMENT ON TABLE "AUTORIZACION_CERTIFICADO"  IS 'Contiene la información relativa a las autorizaciones de los distintas aplicaciones para acceder a los servicios ofrecidos por el emisor';
--------------------------------------------------------
...
-------------------------------------------------------- 
   ...
   COMMENT ON COLUMN "AUTORIZACION_ORGANISMO"."IDAPLICACION" IS 'Identificador de la aplicación a través de la cual el organismo va a enviar peticiones a los servicios del emisor';
   ...
   COMMENT ON TABLE "AUTORIZACION_ORGANISMO"  IS 'Organismos que están dados de alta en el emisor y que van a poder consultar los servicios ofrecidos por este a través de alguna de las aplicaciones que tienen autorización para consultar los servicios';
--------------------------------------------------------
--  Comments for Table EMISOR_BACKOFFICE
-------------------------------------------------------- 

   COMMENT ON COLUMN "EMISOR_BACKOFFICE"."CERTIFICADO" IS 'Código del certificado gestionado por el backoffice';
   ...
   COMMENT ON COLUMN "EMISOR_BACKOFFICE"."TER" IS 'Número de horas que harán esperar a un requirente para la generación de una respuesta definitiva ante una petición asíncrona';
   COMMENT ON TABLE "EMISOR_BACKOFFICE"  IS 'Tabla en la que se configura el módulo de backoffice del emisor que enlaza las comunicaciones SCSP con la logica de negocio especifica de cada organismo';
--------------------------------------------------------
--  Comments for Table SCSP_SECUENCIA_IDTRANSMISION
--------------------------------------------------------

   COMMENT ON COLUMN "SCSP_SECUENCIA_IDTRANSMISION"."PREFIJO" IS 'Prefijo de IdTransmisiones al que estará asociada la secuencia';
   COMMENT ON COLUMN "SCSP_SECUENCIA_IDTRANSMISION"."SECUENCIA" IS 'Valor actual de la secuencia alfanumérica asociada al prefijo';
   COMMENT ON COLUMN "SCSP_SECUENCIA_IDTRANSMISION"."FECHAGENERACION" IS 'Última fecha en la que se ha generado un valor de secuencia';
   COMMENT ON TABLE "SCSP_SECUENCIA_IDTRANSMISION"  IS 'Tabla utilizada para la generación de los valores de los nodos IdTransmisión en los emisores';
...
--------------------------------------------------------
   ...
   COMMENT ON COLUMN "SCSP_CODIGO_ERROR_SECUNDARIO"."CODIGO" IS 'Código identificativo del error especifico secundario';
   COMMENT ON COLUMN "SCSP_CODIGO_ERROR_SECUNDARIO"."DESCRIPCION" IS 'Literal descriptivo del mensaje de error secundario';
   COMMENT ON TABLE "SCSP_CODIGO_ERROR_SECUNDARIO"  IS 'Tabla de errores que permitirá almacenar aquellos mensajes de excepción gestionados por cada lógica de negocio específica de cada emisor, y que estrá asociado a un error genérico de SCSP';
