...
CREATE TABLE ems_acl_object_identity (id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, object_id_class BIGINT NOT NULL, object_id_identity BIGINT NOT NULL, parent_object BIGINT, owner_sid BIGINT NOT NULL, entries_inheriting BOOLEAN NOT NULL, CONSTRAINT ems_acl_object_identity_pk PRIMARY KEY (id));
