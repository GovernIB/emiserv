CREATE TABLE ems_backoffice_com (id BIGINT NOT NULL, peticio_id BIGINT NOT NULL, peticio_data TIMESTAMP WITHOUT TIME ZONE NOT NULL, peticio_xml TEXT NOT NULL, solicitud_id BIGINT, resposta_data TIMESTAMP WITHOUT TIME ZONE, resposta_xml TEXT, error TEXT, version BIGINT NOT NULL, CONSTRAINT ems_backoffice_com_pk PRIMARY KEY (id));

CREATE TABLE ems_backoffice_pet (id BIGINT NOT NULL, peticio_id VARCHAR(26) NOT NULL, estat INTEGER NOT NULL, ter_data TIMESTAMP WITHOUT TIME ZONE NOT NULL, darrera_sol_data TIMESTAMP WITHOUT TIME ZONE, darrera_sol_id VARCHAR(256), processades_error INTEGER, processades_total INTEGER, comunicacio_id BIGINT, version BIGINT NOT NULL, CONSTRAINT ems_backoffice_pet_pk PRIMARY KEY (id));

CREATE TABLE ems_backoffice_sol (id BIGINT NOT NULL, peticio_id BIGINT NOT NULL, solicitud_id VARCHAR(256), comunicacio_id BIGINT, estat INTEGER, version BIGINT NOT NULL, CONSTRAINT ems_backoffice_sol_pk PRIMARY KEY (id));

CREATE TABLE ems_redir_missatge (id BIGINT NOT NULL, tipus INTEGER NOT NULL, peticio_id BIGINT NOT NULL, xml TEXT, version BIGINT NOT NULL, CONSTRAINT ems_redir_msg_pk PRIMARY KEY (id));

CREATE TABLE ems_redir_peticio (id BIGINT NOT NULL, data_comprovacio TIMESTAMP WITHOUT TIME ZONE, data_peticio TIMESTAMP WITHOUT TIME ZONE, data_resposta TIMESTAMP WITHOUT TIME ZONE, emissor_codi VARCHAR(10), error TEXT, estat VARCHAR(16) NOT NULL, num_enviaments INTEGER NOT NULL, num_transmissions INTEGER NOT NULL, peticio_id VARCHAR(128) NOT NULL, servei_codi VARCHAR(256) NOT NULL, sincrona BOOLEAN, ter TIMESTAMP WITHOUT TIME ZONE, version BIGINT NOT NULL, CONSTRAINT ems_redir_pet_pk PRIMARY KEY (id));

CREATE TABLE ems_redir_solicitud (id BIGINT NOT NULL, solicitud_id VARCHAR(256) NOT NULL, solicitant_id VARCHAR(40) NOT NULL, solicitant_nom VARCHAR(256), consentiment VARCHAR(3), data_generacio TIMESTAMP WITHOUT TIME ZONE, error TEXT, estat VARCHAR(4), finalitat VARCHAR(256), funcionari_doc VARCHAR(16), funcionari_nom VARCHAR(160), procediment_codi VARCHAR(256), procediment_nom VARCHAR(256), titular_doc VARCHAR(16), titular_llinatge1 VARCHAR(160), titular_llinatge2 VARCHAR(160), titular_nom VARCHAR(160), titular_nom_sencer VARCHAR(256), transmision_id VARCHAR(256), unitat_tramitadora VARCHAR(256), peticio_id BIGINT NOT NULL, version BIGINT NOT NULL, CONSTRAINT ems_redir_sol_pk PRIMARY KEY (id));

CREATE TABLE ems_servei (id BIGINT NOT NULL, codi VARCHAR(64) NOT NULL, nom VARCHAR(256) NOT NULL, tipus INTEGER NOT NULL, descripcio VARCHAR(1024), configurat BOOLEAN, actiu BOOLEAN, backcaib_async_ter INTEGER, backcaib_async_tipus INTEGER, backcaib_autenticacio INTEGER, backcaib_url VARCHAR(256), backoffice_class VARCHAR(256), resolver_class VARCHAR(256), response_resolver_class VARCHAR(256), url_per_defecte VARCHAR(256), xsd_activa BOOLEAN, xsd_esquema_bak VARCHAR(256), createdby_codi VARCHAR(64) NOT NULL, createddate TIMESTAMP WITHOUT TIME ZONE NOT NULL, lastmodifiedby_codi VARCHAR(64), lastmodifieddate TIMESTAMP WITHOUT TIME ZONE, version BIGINT NOT NULL, CONSTRAINT ems_servei_pk PRIMARY KEY (id));

CREATE TABLE ems_servei_ruta_desti (id BIGINT NOT NULL, entitat_codi VARCHAR(64) NOT NULL, ordre BIGINT, url VARCHAR(256) NOT NULL, servei_id BIGINT NOT NULL, createdby_codi VARCHAR(64) NOT NULL, createddate TIMESTAMP WITHOUT TIME ZONE NOT NULL, lastmodifiedby_codi VARCHAR(64), lastmodifieddate TIMESTAMP WITHOUT TIME ZONE, version BIGINT NOT NULL, CONSTRAINT ems_servei_rut_des_pk PRIMARY KEY (id));

CREATE TABLE ems_usuari (codi VARCHAR(64) NOT NULL, idioma VARCHAR(2) DEFAULT 'CA', version BIGINT NOT NULL, CONSTRAINT ems_usuari_pk PRIMARY KEY (codi));

CREATE TABLE ems_acl_sid (id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, principal BOOLEAN NOT NULL, sid VARCHAR(100) NOT NULL, CONSTRAINT ems_acl_sid_pk PRIMARY KEY (id));

CREATE TABLE ems_acl_class (id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, class VARCHAR(100) NOT NULL, CONSTRAINT ems_acl_class_pk PRIMARY KEY (id));

CREATE TABLE ems_acl_object_identity (id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, object_id_class BIGINT NOT NULL, object_id_identity VARCHAR(36) NOT NULL, parent_object BIGINT, owner_sid BIGINT NOT NULL, entries_inheriting BOOLEAN NOT NULL, CONSTRAINT ems_acl_object_identity_pk PRIMARY KEY (id));

CREATE TABLE ems_acl_entry (id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, acl_object_identity BIGINT NOT NULL, ace_order BIGINT NOT NULL, sid BIGINT NOT NULL, mask INTEGER NOT NULL, granting BOOLEAN NOT NULL, audit_success BOOLEAN NOT NULL, audit_failure BOOLEAN NOT NULL, CONSTRAINT ems_acl_entry_pk PRIMARY KEY (id));

CREATE TABLE core_cache_certificados (numserie VARCHAR(256) NOT NULL, autoridadcertif VARCHAR(512) NOT NULL, tiempocomprobacion TIMESTAMP WITHOUT TIME ZONE NOT NULL, revocado INTEGER DEFAULT 1 NOT NULL, CONSTRAINT core_cache_certificados_pk PRIMARY KEY (numserie, autoridadcertif));
...
CREATE TABLE core_clave_privada (id BIGINT NOT NULL, alias VARCHAR(256) NOT NULL, nombre VARCHAR(256) NOT NULL, passwd VARCHAR(256) NOT NULL, numeroserie VARCHAR(256) NOT NULL, fechabaja TIMESTAMP WITHOUT TIME ZONE, fechaalta TIMESTAMP WITHOUT TIME ZONE NOT NULL, organismo BIGINT, interoperabilidad BOOLEAN, CONSTRAINT core_clave_privada_pk PRIMARY KEY (id));
...
CREATE TABLE core_clave_publica (id BIGINT NOT NULL, alias VARCHAR(256) NOT NULL, nombre VARCHAR(256) NOT NULL, numeroserie VARCHAR(256) NOT NULL, fechaalta TIMESTAMP WITHOUT TIME ZONE NOT NULL, fechabaja TIMESTAMP WITHOUT TIME ZONE, CONSTRAINT core_clave_publica_pk PRIMARY KEY (id));
...
CREATE TABLE core_codigo_error (codigo VARCHAR(4) NOT NULL, descripcion VARCHAR(1024) NOT NULL, CONSTRAINT core_codigo_error_pk PRIMARY KEY (codigo));
...
CREATE TABLE core_emisor_certificado (id BIGINT NOT NULL, nombre VARCHAR(50) NOT NULL, cif VARCHAR(16) NOT NULL, fechaalta TIMESTAMP WITHOUT TIME ZONE, fechabaja TIMESTAMP WITHOUT TIME ZONE, CONSTRAINT core_emisor_certificado_pk PRIMARY KEY (id));
...
CREATE TABLE core_estado_peticion (codigo VARCHAR(4) NOT NULL, mensaje VARCHAR(256) NOT NULL, CONSTRAINT core_estado_peticion_pk PRIMARY KEY (codigo));
...
CREATE TABLE core_modulo (nombre VARCHAR(256) NOT NULL, descripcion VARCHAR(512), activoentrada INTEGER DEFAULT 1 NOT NULL, activosalida INTEGER DEFAULT 1 NOT NULL, CONSTRAINT core_modulo_pk PRIMARY KEY (nombre));
...
CREATE TABLE core_modulo_configuracion (certificado BIGINT NOT NULL, modulo VARCHAR(256) NOT NULL, activoentrada INTEGER DEFAULT 1 NOT NULL, activosalida INTEGER DEFAULT 1 NOT NULL, CONSTRAINT core_modulo_config_pk PRIMARY KEY (certificado, modulo));
...
CREATE TABLE core_req_modulo_pdf (nombre VARCHAR(256) NOT NULL, activo INTEGER DEFAULT 1 NOT NULL, orden INTEGER NOT NULL, CONSTRAINT core_req_modulo_pdf_pk PRIMARY KEY (nombre));

CREATE TABLE core_req_modulo_pdf_cesionario (servicio BIGINT NOT NULL, organismo BIGINT NOT NULL, modulo VARCHAR(256) NOT NULL, activo INTEGER DEFAULT 1 NOT NULL, CONSTRAINT core_req_modpdf_ces_pk PRIMARY KEY (servicio, organismo, modulo));

CREATE TABLE core_em_autorizacion_organismo (id BIGINT NOT NULL, idorganismo VARCHAR(16) NOT NULL, fechaalta TIMESTAMP WITHOUT TIME ZONE NOT NULL, fechabaja TIMESTAMP WITHOUT TIME ZONE, nombreorganismo VARCHAR(64), CONSTRAINT core_em_autorizacion_org_pk PRIMARY KEY (id));
...
CREATE TABLE core_organismo_cesionario (id BIGINT NOT NULL, fechaalta TIMESTAMP WITHOUT TIME ZONE NOT NULL, fechabaja TIMESTAMP WITHOUT TIME ZONE, nombre VARCHAR(50) NOT NULL, cif VARCHAR(50) NOT NULL, bloqueado INTEGER DEFAULT 0 NOT NULL, logo OID, codigounidadtramitadora VARCHAR(9), CONSTRAINT core_organismo_cesionario_pk PRIMARY KEY (id));

CREATE TABLE core_parametro_configuracion (nombre VARCHAR(64) NOT NULL, valor VARCHAR(512) NOT NULL, descripcion VARCHAR(512), CONSTRAINT core_parametro_config_pk PRIMARY KEY (nombre));
...
CREATE TABLE core_peticion_respuesta (idpeticion VARCHAR(26) NOT NULL, certificado BIGINT NOT NULL, estado VARCHAR(4) NOT NULL, estadosecundario VARCHAR(16), fechapeticion TIMESTAMP WITHOUT TIME ZONE, fecharespuesta TIMESTAMP WITHOUT TIME ZONE, ter TIMESTAMP WITHOUT TIME ZONE, numeroenvios INTEGER DEFAULT 0 NOT NULL, numerotransmisiones INTEGER DEFAULT 1 NOT NULL, fechaultimosondeo TIMESTAMP WITHOUT TIME ZONE, transmisionsincrona INTEGER DEFAULT 1 NOT NULL, descompuesta VARCHAR(1), error VARCHAR(4000), errorsecundario VARCHAR(1024), CONSTRAINT core_peticion_respuesta_pk PRIMARY KEY (idpeticion));
...
CREATE TABLE core_servicio (id BIGINT NOT NULL, codcertificado VARCHAR(64) NOT NULL, descripcion VARCHAR(512) NOT NULL, urlsincrona VARCHAR(256), urlasincrona VARCHAR(256), actionsincrona VARCHAR(256), actionasincrona VARCHAR(256), actionsolicitud VARCHAR(256), versionesquema VARCHAR(32) NOT NULL, tiposeguridad VARCHAR(16) NOT NULL, prefijopeticion VARCHAR(9), xpathcifradosincrono VARCHAR(256), xpathcifradoasincrono VARCHAR(256), esquemas VARCHAR(256), clavecifrado BIGINT, clavefirma BIGINT, algoritmocifrado VARCHAR(32), numeromaximoreenvios INTEGER NOT NULL, maxsolicitudespeticion INTEGER NOT NULL, prefijoidtransmision VARCHAR(9), emisor BIGINT NOT NULL, fechaalta TIMESTAMP WITHOUT TIME ZONE NOT NULL, fechabaja TIMESTAMP WITHOUT TIME ZONE, caducidad INTEGER DEFAULT 0 NOT NULL, xpathliteralerror VARCHAR(256), xpathcodigoerror VARCHAR(256), xpathcodigoerrorsecundario VARCHAR(256), timeout INTEGER DEFAULT 60 NOT NULL, validacionfirma VARCHAR(32) DEFAULT 'estricto', plantillaxslt VARCHAR(512), CONSTRAINT core_servicio_pk PRIMARY KEY (id));
...
CREATE TABLE core_tipo_mensaje (tipo INTEGER NOT NULL, descripcion VARCHAR(32) NOT NULL, CONSTRAINT core_tipo_mensaje_pk PRIMARY KEY (tipo));
...
CREATE TABLE core_token_data (idpeticion VARCHAR(26) NOT NULL, tipomensaje INTEGER NOT NULL, datos TEXT NOT NULL, clave VARCHAR(256), modoencriptacion VARCHAR(32), algoritmoencriptacion VARCHAR(32), CONSTRAINT core_token_data_pk PRIMARY KEY (idpeticion, tipomensaje));
...
CREATE TABLE core_transmision (idsolicitud VARCHAR(64) NOT NULL, idpeticion VARCHAR(26) NOT NULL, idtransmision VARCHAR(64), idsolicitante VARCHAR(10) NOT NULL, nombresolicitante VARCHAR(256), doctitular VARCHAR(30), nombretitular VARCHAR(40), apellido1titular VARCHAR(40), apellido2titular VARCHAR(40), nombrecompletotitular VARCHAR(122), docfuncionario VARCHAR(16), nombrefuncionario VARCHAR(128), seudonimofuncionario VARCHAR(32), fechageneracion TIMESTAMP WITHOUT TIME ZONE, unidadtramitadora VARCHAR(250), codigounidadtramitadora VARCHAR(9), codigoprocedimiento VARCHAR(256), nombreprocedimiento VARCHAR(256), expediente VARCHAR(65), finalidad VARCHAR(256), consentimiento VARCHAR(3), error VARCHAR(4000), xmltransmision TEXT, estado VARCHAR(10), estadosecundario VARCHAR(16), CONSTRAINT core_transmision_pk PRIMARY KEY (idsolicitud, idpeticion));
...
CREATE TABLE core_em_aplicacion (idaplicacion INTEGER NOT NULL, nifcertificado VARCHAR(16), numeroserie VARCHAR(64) NOT NULL, cn VARCHAR(512), tiempocomprobacion TIMESTAMP WITHOUT TIME ZONE, autoridadcertif BIGINT NOT NULL, fechaalta TIMESTAMP WITHOUT TIME ZONE, fechabaja TIMESTAMP WITHOUT TIME ZONE, descripcion VARCHAR(512), CONSTRAINT core_em_aplicacion_pk PRIMARY KEY (idaplicacion));
...
CREATE TABLE core_em_autorizacion_ca (id BIGINT NOT NULL, codca VARCHAR(512) NOT NULL, nombre VARCHAR(256), CONSTRAINT core_em_autorizacion_ca_pk PRIMARY KEY (id));
...
CREATE TABLE core_em_autorizacion_cert (id BIGINT NOT NULL, idcertificado BIGINT NOT NULL, idorganismo BIGINT NOT NULL, idaplicacion INTEGER NOT NULL, fechaalta TIMESTAMP WITHOUT TIME ZONE, fechabaja TIMESTAMP WITHOUT TIME ZONE, CONSTRAINT core_em_autorizacion_cert_pk PRIMARY KEY (id));
...
CREATE TABLE core_em_codigo_error_secun (codigo VARCHAR(4) NOT NULL, codigosecundario VARCHAR(16) NOT NULL, descripcion TEXT NOT NULL, CONSTRAINT core_em_cod_error_secun_pk PRIMARY KEY (codigo, codigosecundario));
...
CREATE TABLE core_em_backoffice (certificado BIGINT NOT NULL, beanname VARCHAR(256), classname VARCHAR(256), ter INTEGER NOT NULL, CONSTRAINT core_em_backoffice_pk PRIMARY KEY (certificado));
