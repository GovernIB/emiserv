...
INSERT INTO core_parametro_configuracion(nombre, valor, descripcion) VALUES ('version.datamodel.scsp','4.16.0','Especifica la versión del modelo de datos actual');
...
INSERT INTO core_parametro_configuracion(nombre, valor, descripcion) VALUES ('task.polling.size','50','Número de peticiones máximo a ser tratadas por ciclo de polling');
