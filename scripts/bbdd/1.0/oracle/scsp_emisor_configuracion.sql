...
Insert into CORE_PARAMETRO_CONFIGURACION (NOMBRE,VALOR,DESCRIPCION) values ('prefijo.idtransmision',null,'Cuando no haya indicado un prefijo asociado al servicio y este si esté definido se utilizará este para la generación del id de transmisión.');
INSERT INTO CORE_PARAMETRO_CONFIGURACION (NOMBRE,VALOR,DESCRIPCION) VALUES ('version.datamodel.scsp','3.2.2','Especifica la versión del modelo de datos actual');
...
-- Se debe modificar según necesidades los parámetros '1' Activado por defecto ó '0' desactivado
--------------------------------------------------------
