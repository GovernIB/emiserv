...
<body>
	...
	<form:form action="${formAction}" method="post" cssClass="form-horizontal" commandName="clauPublicaCommand">
		...
		<div class="row">
			<div class="col-md-12">
				<emi:inputText name="alies" required="true" labelSize="1" inline="false" textKey="claupublica.form.camp.alies"/>
				<emi:inputText name="nom" required="true" labelSize="1" inline="false" textKey="claupublica.form.camp.nom"/>
				<emi:inputText name="numSerie" required="true" labelSize="1" inline="false" textKey="claupublica.form.camp.numserie"/>
				<emi:inputDate name="dataAlta" required="true" labelSize="1" inline="false" textKey="claupublica.form.camp.dataalta"/>
				<emi:inputDate name="dataBaixa" required="false" labelSize="1" inline="false" textKey="claupublica.form.camp.databaixa"/>
