...
<body>
	...
	<form:form action="${formAction}" method="post" cssClass="form-horizontal" commandName="serveiCommand" role="form" style="height:400px;">
		<form:hidden path="id"/>
		<c:choose>
		...
		<div id="camps-resolver">
			<emi:inputSelect name="resolverClass" textKey="servei.form.camp.class.resolv" optionItems="${classesResolver}"/>
			<emi:inputText name="urlPerDefecte" textKey="servei.form.camp.url.defecte"/>
		</div>
		<div id="camps-multi-resolver">
			<emi:inputSelect name="responseResolverClass" textKey="servei.form.camp.class.responseResolver" optionItems="${classesResponseResolver}"/>
		</div>
