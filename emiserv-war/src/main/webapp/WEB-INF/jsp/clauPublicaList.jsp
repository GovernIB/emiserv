...
<body>
	...
	<div class="containter-fluid">
		...
		<table id="table-claus" data-toggle="datatable" data-url="claupublica/datatable" data-search-enabled="false" data-botons-template="#botonsTemplate" class="table table-striped table-bordered" style="width:100%">
		<thead>
			<tr>
	...
	<div class="btn-group">
		...
		<ul class="dropdown-menu">
			<li><a href="<c:url value="/scsp/claupublica/{{:id}}"/>" ><i class="fa fa-pencil"></i>&nbsp;<spring:message code="comu.boto.modificar"/></a></li>
			<li><a href="<c:url value="/scsp/claupublica/{{:id}}/delete"/>" data-confirm="<spring:message code="claupublica.list.confirmacio.esborrar"/>"><i class="fa fa-trash-o"></i>&nbsp;<spring:message code="comu.boto.esborrar"/></a></li>
		</ul>
	</div>
					</script>
				</th>
