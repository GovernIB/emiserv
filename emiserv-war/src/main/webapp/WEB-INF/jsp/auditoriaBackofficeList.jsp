...
pageContext.setAttribute(
		...
		es.caib.emiserv.war.helper.HtmlSelectOptionHelper.getOptionsForEnum(
				es.caib.emiserv.core.api.dto.PeticioEstatEnumDto.class,
				"peticio.estat.enum."));
%>
<html>
<head>
...
<body>
	<form:form action="" method="post" cssClass="well" commandName="auditoriaFiltreCommand">
		<div class="row">
			<div class="col-md-4">
			...
			<tr>
				...
				<th data-col-name="peticioId" data-template="#cellPeticioIdTemplate" width="25%">
					<script id="cellPeticioIdTemplate" type="text/x-jsrender">
						{{:peticioId}}{{if !sincrona}}<span class="label label-default pull-right">A</span>{{/if}}
					</script>
