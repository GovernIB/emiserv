...
import es.caib.emiserv.back.command.AutoritzacioCommand;
import es.caib.emiserv.back.command.AutoritzacioFiltreCommand;
...
/**
 * Controlador per a la gestió de les autoritzacions SCSP.
 * 
...
public class AutoritzacioController extends BaseController {
	...
	public String get(
		...
		AutoritzacioFiltreCommand command = (AutoritzacioFiltreCommand)es.caib.emiserv.back.helper.RequestSessionHelper.obtenirObjecteSessio(
				request,
