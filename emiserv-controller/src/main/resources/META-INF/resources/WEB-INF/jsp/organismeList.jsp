...
<body>
					...
					<script id="cellAccionsTemplate" type="text/x-jsrender">
						<div class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="organisme/{{:id}}" data-toggle="modal" data-reload-on-close="false"><span class="fa fa-pencil"></span>&nbsp;&nbsp;<spring:message code="comu.boto.modificar"/></a></li>
	...
	<script id="botonsTemplate" type="text/x-jsrender">
		<a id="accio-new" class="btn btn-default pull-right" href="organisme/new" data-toggle="modal" data-reload-on-close="false" data-datatable-id="organismes"><span class="fa fa-plus"></span>&nbsp;<spring:message code="organisme.list.boto.nou.organisme"/></a>
	</script>
</body>