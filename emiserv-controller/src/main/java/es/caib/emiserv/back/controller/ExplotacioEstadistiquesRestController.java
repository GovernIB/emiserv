...
@Tag(name="Estadístiques", description = "Servei de consulta d'estadístiques'")
@RestController
...
public class ExplotacioEstadistiquesRestController {
    ...
    @GetMapping(value= "/stats/consultes", produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<Entitat> consultes(
            HttpServletRequest request,
            @RequestParam final @Parameter(description = "Nif de l’entitat") String entitatNif,
    ...
    @GetMapping(value= "/stats/carrega", produces = MediaType.APPLICATION_JSON_VALUE)
