...
public class ScspCoreClavePrivadaEntity implements Serializable {
	...
	private ScspCoreOrganismoCessionarioEntity organisme;
	...
	public void update(
			...
			ScspCoreOrganismoCessionarioEntity organisme) {
		this.alies = alies;
		this.nom = nom;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ScspCoreClavePrivadaEntity other = (ScspCoreClavePrivadaEntity) obj;
		if (getId() == null) {
			if (other.getId() != null)
				return false;
