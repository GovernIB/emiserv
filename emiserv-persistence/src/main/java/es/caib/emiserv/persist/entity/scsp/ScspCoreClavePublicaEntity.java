...
public class ScspCoreClavePublicaEntity implements Serializable {
	...
	public static class Builder {
		ScspCoreClavePublicaEntity built;
		...
		Builder(
				...
				Date dataAlta,
				Date dataBaixa) {
			built = new ScspCoreClavePublicaEntity();
			built.alies = alies;
			built.nom = nom;
		 ...
		 */
		public ScspCoreClavePublicaEntity build() {
			return built;
		}
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ScspCoreClavePublicaEntity other = (ScspCoreClavePublicaEntity) obj;
		if (getId() == null) {
			if (other.getId() != null)
				return false;
