...
INSERT INTO ems_config (key, description_key, group_code, position, source_property, type_code, value) VALUES ('es.caib.emiserv.log.enrutaments', 'propietat.log.enrutaments', 'GENERAL', '10', 'DATABASE', 'BOOL', 'true');