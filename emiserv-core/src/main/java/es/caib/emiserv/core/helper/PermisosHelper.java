...
import es.caib.emiserv.core.api.dto.ObjecteAmbPermisosDto;
import es.caib.emiserv.core.api.dto.PermisDto;
import es.caib.emiserv.core.api.dto.PrincipalTipusEnumDto;
...
public class PermisosHelper {
	...
	public <T> void filterGrantedAny(
	...
	private String getMapeigRol(String rol) {
		String propertyMapeig = 
				(String)PropertiesHelper.getProperties().get(
						"es.caib.emiserv.mapeig.rol." + rol);
