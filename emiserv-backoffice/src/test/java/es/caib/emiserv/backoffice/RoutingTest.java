...
public class RoutingTest {
	...
	private static final String BACKOFFICE_URL = "http://localhost:8080/emiserv/scspRouting/familiaNombrosa";



	public static void main(String[] args) {
		try {
			RoutingTest backofficeTest = new RoutingTest();
			Peticion peticion = backofficeTest.crearPeticionBackoffice(
					"familiaNombrosa",
					"G07896004",
					"FUNDACIO IBIT",
					"IBIT_20101223_PRUEBA",
					"PETICIO PROVA FAMILIA NOMBROSA",
					"MPR TESTER",
